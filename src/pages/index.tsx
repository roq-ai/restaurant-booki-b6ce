  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Experience effortless dining with Restaurant Booking Engine - Reserving tables, managing reservations and menus, all at your fingertips."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience effortless dining with Restaurant Booking Engine - Reserving tables, managing reservations and menus, all at your fingertips.`}
            </Text>
            <Box
